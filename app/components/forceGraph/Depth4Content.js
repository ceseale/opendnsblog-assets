...
class Depth1Content extends React.Component {
    ...
    render() {
        return (
            ...
            <p style={{ color: 'white' }}>The last depth we'll investigate is depth 4. The graph at this point is huge. This is great because we can start to see more interesting trends and use our toolset to learn more about them. Larger graphs allow you to view massive trends as domains at this length can easily have over 6000 nodes! Below are some interesting trends that continued from depth 3. They show that K means did a good job at separating meaningful groups of domains in large graphs where clusters are less obvious.
